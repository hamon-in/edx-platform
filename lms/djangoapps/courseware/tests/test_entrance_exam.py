...
class EntranceExamTestCases(LoginEnrollmentTestCase, ModuleStoreTestCase, MilestonesTestCaseMixin):
    ...
    def test_entrance_exam_content_absence(self):
        ...
        self.assertNotIn('Exam Vertical - Unit 1', resp.content.decode('utf-8'))
    ...
    def test_entrance_exam_requirement_message_hidden(self):
        ...
        self.assertNotIn('To access course materials, you must score', resp.content.decode('utf-8'))
        self.assertNotIn('You have passed the entrance exam.', resp.content.decode('utf-8'))
